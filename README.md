...
* You can download it from the releases section clicking [here](https://github.com/val-lavric/spert-chess/releases/download/spert_chess/spert_chess.rar), extract and run
